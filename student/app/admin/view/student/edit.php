    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="index.php?s=admin/student/index">student list</a></li>
                <li class="active"><a href="index.php?s=admin/student/create">add student</a></li>
            </ul>
                ...
                <div class="panel-body">
                    <form action="" method="post" class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" id="inputID" class="form-control" value="<?php echo $student['name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    ...
                                    <input type="radio" name="sex" value="男" <?php if ($student['sex'] == '男'){ ?> checked="checked" <?php } ?>> 男
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="sex" value="女" <?php if ($student['sex'] == '女'){ ?> checked="checked" <?php } ?>> 女
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="sex" value="不详" <?php if ($student['sex'] == '不详'){ ?> checked="checked" <?php } ?>> 不详
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="cellphone" class="form-control" value="<?php echo $student['cellphone']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="jieshao" class="form-control" cols="30" rows="10"
                                          style="resize:none;"><?php echo $student['jieshao']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="gid">
                                    ...
                                    <?php foreach ($grade as $k => $v) { ?>
                                        <?php if($v['id'] == $student['gid']){ ?>
                                            <option value="<?php echo $v['id']; ?>" selected="selected"><?php echo $v['username'] ?></option>
                                    <?php }else{ ?>
