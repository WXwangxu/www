    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="index.php?s=admin/student/index">student list</a></li>
                <li><a href="index.php?s=admin/student/create">add student</a></li>
            </ul>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="index.php?s=admin/student/edit&id=<?php echo $v['id']; ?>" class="btn btn-primary">编辑</a>
    ...
    <script>
        function del(id) {
            if(confirm('确定删除该班级数据吗?')){
                location.href = 'index.php?s=admin/student/delete&id=' + id;
            }
        }
