<template>
  <div>
    ...
    <swiper :options="swiperOption">
      <swiper-slide v-for="v in slider" :key="v.id"><img :src="v.slider" alt="">
      </swiper-slide>
    ...
    <div class="today">
      ...
      <div class="pic">
        <router-link :to="'/page/'+v.id" v-for="v in CommendHost" :key="v.id">
          <img :src="v.thumb" alt="" />
          <i class="iconfont icon-bofang"></i>
          <span class="time">{{v.created_at}}</span>
          <span class="title">{{v.title}}</span>
...
export default {
  ...
  data () {
    ...
    methods:{
        getSlider(){
            Vue.axios.get('http://laravelvedio.annied.cn/getSlider').then((response) => {
                // console.log(response.data);
                this.slider = response.data;
            })
        },
        getCommendLessons(){
            Vue.axios.get('http://laravelvedio.annied.cn/getCommendLessons/4').then((response) => {
                // console.log(response.data)
                this.commendLessons = response.data;
            })
        },
        getCommendHost(){
            Vue.axios.get('http://laravelvedio.annied.cn/getCommendHost/4').then((response) => {
                // console.log(response.data)
                this.CommendHost = response.data;
            })
        }
    }
}
